...
namespace FinTP
{
	...
	class ExportedObject TemplateData
	{
		...
		private :
			...
			NodeMatchReturn MatchSingle( const ManagedBuffer& buffer, DOMElement* root );
		...
		public :
			...
			NodeMatchReturn Matches( const ManagedBuffer& buffer, DOMNode *root );
	};
	...
	class ExportedObject TemplateNode
	{
		...
		public :
			...
			virtual bool MatchTemplate( const ManagedBuffer& buffer, DOMNode *root );
	...
	class ExportedObject TemplateNodeRoot : public TemplateNode
	{
		...
		public :
			...
			bool MatchTemplate( const ManagedBuffer& buffer, DOMNode *root );
	...
	class ExportedObject TemplateParser
	{
		...
		public:
			...
			bool Matches( const ManagedBuffer& buffer, XERCES_CPP_NAMESPACE_QUALIFIER DOMNode* root );
