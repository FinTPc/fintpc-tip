...
namespace FinTP
{
	...
	class ExportedObject AppSettings
	{
		public :
			...
			/** 
			 * Contains config file entries for FinTP connectors
			 */
			enum ConfigSettings
			{
				// Common settings
		...
		public:
			...
			//constructors
			AppSettings( void );
			explicit AppSettings( const string& configFileName, const string& configContent = "", const string& encryptionKey = "" );
			...
			void loadConfig( const string& configFilename, const string& configContent = "", const string& encryptionKey = "" );
