...
// new dbv2
const string RoutingMessageEvaluator::AGGREGATIONTOKEN_FTPID = "CORRELATIONID";
const string RoutingMessageEvaluator::AGGREGATIONTOKEN_FTPCODE = "APPLICATIONCODE";
const string RoutingMessageEvaluator::AGGREGATIONTOKEN_SAACODE = "INTERFACECODE";
const string RoutingMessageEvaluator::AGGREGATIONTOKEN_TFDCODE = "CORRESPONDENTCODE";
...
const string RoutingMessageEvaluator::AGGREGATIONTOKEN_REQUESTOR = "REQUESTORSERVICE";
...
const string RoutingMessageEvaluator::AGGREGATIONTOKEN_BATCHSEQ = "BATCHSEQUENCE";
const string RoutingMessageEvaluator::AGGREGATIONTOKEN_TRN = "REFERENCE";
...
const string RoutingMessageEvaluator::AGGREGATIONTOKEN_CORRELID = "CORRELATIONID";
...
const string RoutingMessageEvaluator::m_FeedbackIds[ FEEDBACK_PROVIDER_COUNT ] = { 
	...
	const string InternalXmlPayload::m_FieldNames[ INTERNALXMLPAYLOAD_FIELDCOUNT ] = {
		...
		"OrderingBank",//ex SenderCorresp,
		"BeneficiaryBank",//"ReceiverCorresp",
		"OriginalReference",//OriginalTransactionId, 056, 029
		"RCode", //ReasonCode
		"OriginalInstructedID",// ex OriginalInstructedId
		"OrigBatchID"
	};
...
const string InternalEvaluatorWrapper::m_FieldNames[ ENRICHEVALUATORLWRAPPER_FIELDCOUNT ] = {
	"sourcefilename",
	"destinationfilename"
};
...
RoutingMessageEvaluator* RoutingMessageEvaluator::getEvaluator( const XERCES_CPP_NAMESPACE_QUALIFIER DOMDocument* document )
{
	...
	try
	{
		...
		if( returnedEvaluator != NULL && !returnedEvaluator->isEnrichFormat() )
		{
...
bool RoutingMessageEvaluator::isIso( const string& msgNamespace )
{
	return ( ( msgNamespace == "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.01" ) ||
		...
		( msgNamespace == "urn:fintp:mfi:payment.01" )  ||
		( msgNamespace == "urn:iso:std:iso:20022:tech:xsd:pain.001.001.08Alv" ) ||
		( msgNamespace == "urn:iso:std:iso:20022:tech:xsd:camt.054.001.06Alv" ) );
}
...
{
	return ( CheckPayloadType( RoutingMessageEvaluator::FINTPENRCH ) );
}
...
string RoutingMessageEvaluator::getMessageType()
{
