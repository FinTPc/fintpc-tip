...
#ifndef EXTENSIONESCAPE_H
#define EXTENSIONESCAPE_H
...
namespace FinTP
{
	class ExportedObject FunctionEscape : public Function
	{
		public:
			...
			#else
				virtual FunctionEscape* clone( MemoryManagerType& theManager ) const;
			#endif
		protected:
			...
			#else
				virtual FunctionEscape* clone() const;
			#endif
		protected:
		...
		private:
			...
			FunctionEscape& operator=( const FunctionEscape& );
			bool operator==( const FunctionEscape& ) const;
	};
}

#endif // EXTENSIONESCAPE_H
