...
#ifndef EXTENSIONUPPER_H
#define EXTENSIONUPPER_H
...
namespace FinTP
{
	class ExportedObject FunctionUpper : public Function
	{
		public:
			...
			#else
				virtual FunctionUpper* clone( MemoryManagerType& theManager ) const;
			#endif
		protected:
			...
			#else
				virtual FunctionUpper* clone() const;
			#endif
		protected:
		...
		private:
			...
			FunctionUpper& operator=( const FunctionUpper& );
			bool operator==( const FunctionUpper& ) const;
	};
}

#endif // EXTENSIONUPPER_H
