...
#ifdef WIN32
	#ifdef _TRANSPORTRDLL
		#define ExportedTransportObject __declspec( dllexport )
	#else
		#define ExportedTransportObject __declspec( dllimport )
	#endif
#else
	#define ExportedTransportObject 
#endif

#ifndef DLLMAIN_FINTP_TRANSPORT_LIB
#define DLLMAIN_FINTP_TRANSPORT_LIB
...
namespace FinTP
{
	...
	*/
	class ExportedTransportObject TransportVersionInfo
	{
		private : 
			/// \brief Constructor
			TransportVersionInfo(){};
...
#endif // DLLMAIN_FINTP_TRANSPORT_LIB
